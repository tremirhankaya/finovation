...
function toSnapshot(response: FundMonitoringResponse): FundMonitoringSnapshot {
  return {
    ...
    backtestHistory: response.backtestHistory,
    backtestCurrentValue: response.backtestCurrentValue,
    backtestDailyChangePercentage: response.backtestDailyChangePercentage,
